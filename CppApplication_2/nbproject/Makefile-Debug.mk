...
LDLIBSOPTIONS=-L/usr/include/GL -Wl,-rpath,'/usr/include/GL' `pkg-config --libs gl` -lm  -ldl   
...
${OBJECTDIR}/main.o: main.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -include /usr/include/GL/glut.h -include /usr/include/GL/glu.h -include /usr/include/GL/glut.h `pkg-config --cflags gl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c
